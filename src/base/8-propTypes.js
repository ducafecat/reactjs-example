...
const PropTypesComponent = props => (
  <ul>
    ...
    <li>optionalUnion - {props.optionalUnion}</li>
    <li>
      optionalObjectWithShape - color: {props.optionalObjectWithShape.color} ,
      fontSize: {props.optionalObjectWithShape.fontSize}
    </li>
...
PropTypesComponent.propTypes = {
  ...
  optionalUnion: PropTypes.oneOfType([PropTypes.string, PropTypes.number]), // 限制它为列举类型之一的对象
